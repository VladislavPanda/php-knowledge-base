                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                                <thead>
                                                <tr>
                                                    <th class="sorting sorting_asc col-sm-2" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Номер вопроса</th>
                                                    <th class="sorting sorting_asc col-sm-10" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Текст вопроса</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                    @foreach ($questions as $question)
                                                        <tr class="odd">
                                                            <td class="dtr-control sorting_1">{{ $question->getId() }}</td>
                                                            <td><a href="{{ route('question.show', $question->getId()) }}">{{ $question->getContent() }}</a></td>
                                                            @can('edit', \App\Models\Question::class)
                                                                <td>
